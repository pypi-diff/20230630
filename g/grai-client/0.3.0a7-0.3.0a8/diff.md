# Comparing `tmp/grai_client-0.3.0a7.tar.gz` & `tmp/grai_client-0.3.0a8.tar.gz`
...
### Comparing `grai_client-0.3.0a7/src/grai_client/authentication.py` & `grai_client-0.3.0a8/src/grai_client/authentication.py`
