# Comparing `tmp/grai_client-0.3.0a5.tar.gz` & `tmp/grai_client-0.3.0a6.tar.gz`
...
### Comparing `grai_client-0.3.0a5/src/grai_client/authentication.py` & `grai_client-0.3.0a6/src/grai_client/authentication.py`
