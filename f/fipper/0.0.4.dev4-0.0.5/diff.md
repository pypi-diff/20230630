# Comparing `tmp/fipper-0.0.4.dev4.tar.gz` & `tmp/fipper-0.0.5.tar.gz`
...
### Comparing `fipper-0.0.4.dev4/LICENSE` & `fipper-0.0.5/LICENSE`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/NOTICE` & `fipper-0.0.5/NOTICE`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/PKG-INFO` & `fipper-0.0.5/PKG-INFO`
...
### Comparing `fipper-0.0.4.dev4/README.md` & `fipper-0.0.5/README.md`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/__init__.py` & `fipper-0.0.5/compiler/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/api/__init__.py` & `fipper-0.0.5/compiler/api/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/api/compiler.py` & `fipper-0.0.5/compiler/api/compiler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/api/source/auth_key.tl` & `fipper-0.0.5/compiler/api/source/auth_key.tl`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/api/source/main_api.tl` & `fipper-0.0.5/compiler/api/source/main_api.tl`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/api/source/sys_msgs.tl` & `fipper-0.0.5/compiler/api/source/sys_msgs.tl`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/api/template/combinator.txt` & `fipper-0.0.5/compiler/api/template/combinator.txt`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/api/template/type.txt` & `fipper-0.0.5/compiler/api/template/type.txt`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/errors/__init__.py` & `fipper-0.0.5/compiler/errors/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/errors/compiler.py` & `fipper-0.0.5/compiler/errors/compiler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/errors/sort.py` & `fipper-0.0.5/compiler/errors/sort.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/errors/source/400_BAD_REQUEST.tsv` & `fipper-0.0.5/compiler/errors/source/400_BAD_REQUEST.tsv`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/errors/source/401_UNAUTHORIZED.tsv` & `fipper-0.0.5/compiler/errors/source/401_UNAUTHORIZED.tsv`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/errors/source/403_FORBIDDEN.tsv` & `fipper-0.0.5/compiler/errors/source/403_FORBIDDEN.tsv`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/errors/source/406_NOT_ACCEPTABLE.tsv` & `fipper-0.0.5/compiler/errors/source/406_NOT_ACCEPTABLE.tsv`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/compiler/errors/source/500_INTERNAL_SERVER_ERROR.tsv` & `fipper-0.0.5/compiler/errors/source/500_INTERNAL_SERVER_ERROR.tsv`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/__init__.py` & `fipper-0.0.5/fipper/__init__.py`
...
### Comparing `fipper-0.0.4.dev4/fipper/client.py` & `fipper-0.0.5/fipper/client.py`
...
### Comparing `fipper-0.0.4.dev4/fipper/connection/__init__.py` & `fipper-0.0.5/fipper/connection/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/connection/connection.py` & `fipper-0.0.5/fipper/connection/connection.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/connection/transport/__init__.py` & `fipper-0.0.5/fipper/connection/transport/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/connection/transport/tcp/__init__.py` & `fipper-0.0.5/fipper/connection/transport/tcp/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/connection/transport/tcp/tcp.py` & `fipper-0.0.5/fipper/connection/transport/tcp/tcp.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/connection/transport/tcp/tcp_abridged.py` & `fipper-0.0.5/fipper/connection/transport/tcp/tcp_abridged.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/connection/transport/tcp/tcp_abridged_o.py` & `fipper-0.0.5/fipper/connection/transport/tcp/tcp_abridged_o.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/connection/transport/tcp/tcp_full.py` & `fipper-0.0.5/fipper/connection/transport/tcp/tcp_full.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/connection/transport/tcp/tcp_intermediate.py` & `fipper-0.0.5/fipper/connection/transport/tcp/tcp_intermediate.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/connection/transport/tcp/tcp_intermediate_o.py` & `fipper-0.0.5/fipper/connection/transport/tcp/tcp_intermediate_o.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/crypto/__init__.py` & `fipper-0.0.5/fipper/crypto/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/crypto/aes.py` & `fipper-0.0.5/fipper/crypto/aes.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/crypto/mtproto.py` & `fipper-0.0.5/fipper/crypto/mtproto.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/crypto/prime.py` & `fipper-0.0.5/fipper/crypto/prime.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/crypto/rsa.py` & `fipper-0.0.5/fipper/crypto/rsa.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/dispatcher.py` & `fipper-0.0.5/fipper/dispatcher.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/emoji.py` & `fipper-0.0.5/fipper/emoji.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/__init__.py` & `fipper-0.0.5/fipper/enums/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/auto_name.py` & `fipper-0.0.5/fipper/enums/auto_name.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/chat_action.py` & `fipper-0.0.5/fipper/enums/chat_action.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/chat_event_action.py` & `fipper-0.0.5/fipper/enums/chat_event_action.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/chat_member_status.py` & `fipper-0.0.5/fipper/enums/chat_member_status.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/chat_members_filter.py` & `fipper-0.0.5/fipper/enums/chat_members_filter.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/chat_type.py` & `fipper-0.0.5/fipper/enums/chat_type.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/message_entity_type.py` & `fipper-0.0.5/fipper/enums/message_entity_type.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/message_media_type.py` & `fipper-0.0.5/fipper/enums/message_media_type.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/message_service_type.py` & `fipper-0.0.5/fipper/enums/message_service_type.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/messages_filter.py` & `fipper-0.0.5/fipper/enums/messages_filter.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/next_code_type.py` & `fipper-0.0.5/fipper/enums/next_code_type.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/parse_mode.py` & `fipper-0.0.5/fipper/enums/parse_mode.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/poll_type.py` & `fipper-0.0.5/fipper/enums/poll_type.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/sent_code_type.py` & `fipper-0.0.5/fipper/enums/sent_code_type.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/enums/user_status.py` & `fipper-0.0.5/fipper/enums/user_status.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/errors/__init__.py` & `fipper-0.0.5/fipper/errors/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/errors/rpc_error.py` & `fipper-0.0.5/fipper/errors/rpc_error.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/file_id.py` & `fipper-0.0.5/fipper/file_id.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/filters.py` & `fipper-0.0.5/fipper/filters.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/__init__.py` & `fipper-0.0.5/fipper/handlers/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/callback_query_handler.py` & `fipper-0.0.5/fipper/handlers/callback_query_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/chat_join_request_handler.py` & `fipper-0.0.5/fipper/handlers/chat_join_request_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/chat_member_updated_handler.py` & `fipper-0.0.5/fipper/handlers/chat_member_updated_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/chosen_inline_result_handler.py` & `fipper-0.0.5/fipper/handlers/chosen_inline_result_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/conversation_handler.py` & `fipper-0.0.5/fipper/handlers/conversation_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/deleted_messages_handler.py` & `fipper-0.0.5/fipper/handlers/deleted_messages_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/disconnect_handler.py` & `fipper-0.0.5/fipper/handlers/disconnect_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/edited_message_handler.py` & `fipper-0.0.5/fipper/handlers/edited_message_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/handler.py` & `fipper-0.0.5/fipper/handlers/handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/inline_query_handler.py` & `fipper-0.0.5/fipper/handlers/inline_query_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/message_handler.py` & `fipper-0.0.5/fipper/handlers/message_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/poll_handler.py` & `fipper-0.0.5/fipper/handlers/poll_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/raw_update_handler.py` & `fipper-0.0.5/fipper/handlers/raw_update_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/handlers/user_status_handler.py` & `fipper-0.0.5/fipper/handlers/user_status_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/__init__.py` & `fipper-0.0.5/fipper/methods/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/advanced/__init__.py` & `fipper-0.0.5/fipper/methods/advanced/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/advanced/invoke.py` & `fipper-0.0.5/fipper/methods/advanced/invoke.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/advanced/resolve_peer.py` & `fipper-0.0.5/fipper/methods/advanced/resolve_peer.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/advanced/save_file.py` & `fipper-0.0.5/fipper/methods/advanced/save_file.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/__init__.py` & `fipper-0.0.5/fipper/methods/auth/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/accept_terms_of_service.py` & `fipper-0.0.5/fipper/methods/auth/accept_terms_of_service.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/check_password.py` & `fipper-0.0.5/fipper/methods/auth/check_password.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/connect.py` & `fipper-0.0.5/fipper/methods/auth/connect.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/disconnect.py` & `fipper-0.0.5/fipper/methods/auth/disconnect.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/get_password_hint.py` & `fipper-0.0.5/fipper/methods/auth/get_password_hint.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/initialize.py` & `fipper-0.0.5/fipper/methods/auth/initialize.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/log_out.py` & `fipper-0.0.5/fipper/methods/auth/log_out.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/recover_password.py` & `fipper-0.0.5/fipper/methods/auth/recover_password.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/resend_code.py` & `fipper-0.0.5/fipper/methods/auth/resend_code.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/send_code.py` & `fipper-0.0.5/fipper/methods/auth/send_code.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/send_recovery_code.py` & `fipper-0.0.5/fipper/methods/auth/send_recovery_code.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/sign_in.py` & `fipper-0.0.5/fipper/methods/auth/sign_in.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/sign_in_bot.py` & `fipper-0.0.5/fipper/methods/auth/sign_in_bot.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/sign_up.py` & `fipper-0.0.5/fipper/methods/auth/sign_up.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/auth/terminate.py` & `fipper-0.0.5/fipper/methods/auth/terminate.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/__init__.py` & `fipper-0.0.5/fipper/methods/bots/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/answer_callback_query.py` & `fipper-0.0.5/fipper/methods/bots/answer_callback_query.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/answer_inline_query.py` & `fipper-0.0.5/fipper/methods/bots/answer_inline_query.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/answer_web_app_query.py` & `fipper-0.0.5/fipper/methods/bots/answer_web_app_query.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/delete_bot_commands.py` & `fipper-0.0.5/fipper/methods/bots/delete_bot_commands.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/get_bot_commands.py` & `fipper-0.0.5/fipper/methods/bots/get_bot_commands.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/get_bot_default_privileges.py` & `fipper-0.0.5/fipper/methods/bots/get_bot_default_privileges.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/get_chat_menu_button.py` & `fipper-0.0.5/fipper/methods/bots/get_chat_menu_button.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/get_game_high_scores.py` & `fipper-0.0.5/fipper/methods/bots/get_game_high_scores.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/get_inline_bot_results.py` & `fipper-0.0.5/fipper/methods/bots/get_inline_bot_results.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/request_callback_answer.py` & `fipper-0.0.5/fipper/methods/bots/request_callback_answer.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/send_game.py` & `fipper-0.0.5/fipper/methods/bots/send_game.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/send_inline_bot_result.py` & `fipper-0.0.5/fipper/methods/bots/send_inline_bot_result.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/set_bot_commands.py` & `fipper-0.0.5/fipper/methods/bots/set_bot_commands.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/set_bot_default_privileges.py` & `fipper-0.0.5/fipper/methods/bots/set_bot_default_privileges.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/set_chat_menu_button.py` & `fipper-0.0.5/fipper/methods/bots/set_chat_menu_button.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/bots/set_game_score.py` & `fipper-0.0.5/fipper/methods/bots/set_game_score.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/__init__.py` & `fipper-0.0.5/fipper/methods/chats/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/add_chat_members.py` & `fipper-0.0.5/fipper/methods/chats/add_chat_members.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/archive_chats.py` & `fipper-0.0.5/fipper/methods/chats/archive_chats.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/ban_chat_member.py` & `fipper-0.0.5/fipper/methods/chats/ban_chat_member.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/create_channel.py` & `fipper-0.0.5/fipper/methods/chats/create_channel.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/create_group.py` & `fipper-0.0.5/fipper/methods/chats/create_group.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/create_supergroup.py` & `fipper-0.0.5/fipper/methods/chats/create_supergroup.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/delete_channel.py` & `fipper-0.0.5/fipper/methods/chats/delete_channel.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/delete_chat_photo.py` & `fipper-0.0.5/fipper/methods/chats/delete_chat_photo.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/delete_supergroup.py` & `fipper-0.0.5/fipper/methods/chats/delete_supergroup.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/delete_user_history.py` & `fipper-0.0.5/fipper/methods/chats/delete_user_history.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_chat.py` & `fipper-0.0.5/fipper/methods/chats/get_chat.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_chat_event_log.py` & `fipper-0.0.5/fipper/methods/chats/get_chat_event_log.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_chat_member.py` & `fipper-0.0.5/fipper/methods/chats/get_chat_member.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_chat_members.py` & `fipper-0.0.5/fipper/methods/chats/get_chat_members.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_chat_members_count.py` & `fipper-0.0.5/fipper/methods/chats/get_chat_members_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_chat_online_count.py` & `fipper-0.0.5/fipper/methods/chats/get_chat_online_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_dialogs.py` & `fipper-0.0.5/fipper/methods/chats/get_dialogs.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_dialogs_count.py` & `fipper-0.0.5/fipper/methods/chats/get_dialogs_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_nearby_chats.py` & `fipper-0.0.5/fipper/methods/chats/get_nearby_chats.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/get_send_as_chats.py` & `fipper-0.0.5/fipper/methods/chats/get_send_as_chats.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/join_chat.py` & `fipper-0.0.5/fipper/methods/chats/join_chat.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/leave_chat.py` & `fipper-0.0.5/fipper/methods/chats/leave_chat.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/mark_chat_unread.py` & `fipper-0.0.5/fipper/methods/chats/mark_chat_unread.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/pin_chat_message.py` & `fipper-0.0.5/fipper/methods/chats/pin_chat_message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/promote_chat_member.py` & `fipper-0.0.5/fipper/methods/chats/promote_chat_member.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/restrict_chat_member.py` & `fipper-0.0.5/fipper/methods/chats/restrict_chat_member.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/set_administrator_title.py` & `fipper-0.0.5/fipper/methods/chats/set_administrator_title.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/set_chat_description.py` & `fipper-0.0.5/fipper/methods/chats/set_chat_description.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/set_chat_permissions.py` & `fipper-0.0.5/fipper/methods/chats/set_chat_permissions.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/set_chat_photo.py` & `fipper-0.0.5/fipper/methods/chats/set_chat_photo.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/set_chat_protected_content.py` & `fipper-0.0.5/fipper/methods/chats/set_chat_protected_content.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/set_chat_title.py` & `fipper-0.0.5/fipper/methods/chats/set_chat_title.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/set_chat_username.py` & `fipper-0.0.5/fipper/methods/chats/set_chat_username.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/set_send_as_chat.py` & `fipper-0.0.5/fipper/methods/chats/set_send_as_chat.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/set_slow_mode.py` & `fipper-0.0.5/fipper/methods/chats/set_slow_mode.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/unarchive_chats.py` & `fipper-0.0.5/fipper/methods/chats/unarchive_chats.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/unban_chat_member.py` & `fipper-0.0.5/fipper/methods/chats/unban_chat_member.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/unpin_all_chat_messages.py` & `fipper-0.0.5/fipper/methods/chats/unpin_all_chat_messages.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/chats/unpin_chat_message.py` & `fipper-0.0.5/fipper/methods/chats/unpin_chat_message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/contacts/__init__.py` & `fipper-0.0.5/fipper/methods/contacts/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/contacts/add_contact.py` & `fipper-0.0.5/fipper/methods/contacts/add_contact.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/contacts/delete_contacts.py` & `fipper-0.0.5/fipper/methods/contacts/delete_contacts.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/contacts/get_contacts.py` & `fipper-0.0.5/fipper/methods/contacts/get_contacts.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/contacts/get_contacts_count.py` & `fipper-0.0.5/fipper/methods/contacts/get_contacts_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/contacts/import_contacts.py` & `fipper-0.0.5/fipper/methods/contacts/import_contacts.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/__init__.py` & `fipper-0.0.5/fipper/methods/decorators/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_callback_query.py` & `fipper-0.0.5/fipper/methods/decorators/on_callback_query.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_chat_join_request.py` & `fipper-0.0.5/fipper/methods/decorators/on_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_chat_member_updated.py` & `fipper-0.0.5/fipper/methods/decorators/on_chat_member_updated.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_chosen_inline_result.py` & `fipper-0.0.5/fipper/methods/decorators/on_chosen_inline_result.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_deleted_messages.py` & `fipper-0.0.5/fipper/methods/decorators/on_deleted_messages.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_disconnect.py` & `fipper-0.0.5/fipper/methods/decorators/on_disconnect.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_edited_message.py` & `fipper-0.0.5/fipper/methods/decorators/on_edited_message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_inline_query.py` & `fipper-0.0.5/fipper/methods/decorators/on_inline_query.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_message.py` & `fipper-0.0.5/fipper/methods/decorators/on_message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_poll.py` & `fipper-0.0.5/fipper/methods/decorators/on_poll.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_raw_update.py` & `fipper-0.0.5/fipper/methods/decorators/on_raw_update.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/decorators/on_user_status.py` & `fipper-0.0.5/fipper/methods/decorators/on_user_status.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/__init__.py` & `fipper-0.0.5/fipper/methods/invite_links/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/approve_all_chat_join_requests.py` & `fipper-0.0.5/fipper/methods/invite_links/approve_all_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/approve_chat_join_request.py` & `fipper-0.0.5/fipper/methods/invite_links/approve_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/create_chat_invite_link.py` & `fipper-0.0.5/fipper/methods/invite_links/create_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/decline_all_chat_join_requests.py` & `fipper-0.0.5/fipper/methods/invite_links/decline_all_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/decline_chat_join_request.py` & `fipper-0.0.5/fipper/methods/invite_links/decline_chat_join_request.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/delete_chat_admin_invite_links.py` & `fipper-0.0.5/fipper/methods/invite_links/delete_chat_admin_invite_links.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/delete_chat_invite_link.py` & `fipper-0.0.5/fipper/methods/invite_links/delete_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/edit_chat_invite_link.py` & `fipper-0.0.5/fipper/methods/invite_links/edit_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/export_chat_invite_link.py` & `fipper-0.0.5/fipper/methods/invite_links/export_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/get_chat_admin_invite_links.py` & `fipper-0.0.5/fipper/methods/invite_links/get_chat_admin_invite_links.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/get_chat_admin_invite_links_count.py` & `fipper-0.0.5/fipper/methods/invite_links/get_chat_admin_invite_links_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/get_chat_admins_with_invite_links.py` & `fipper-0.0.5/fipper/methods/invite_links/get_chat_admins_with_invite_links.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/get_chat_invite_link.py` & `fipper-0.0.5/fipper/methods/invite_links/get_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/get_chat_invite_link_joiners.py` & `fipper-0.0.5/fipper/methods/invite_links/get_chat_invite_link_joiners.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/get_chat_invite_link_joiners_count.py` & `fipper-0.0.5/fipper/methods/invite_links/get_chat_invite_link_joiners_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/get_chat_join_requests.py` & `fipper-0.0.5/fipper/methods/invite_links/get_chat_join_requests.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/invite_links/revoke_chat_invite_link.py` & `fipper-0.0.5/fipper/methods/invite_links/revoke_chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/__init__.py` & `fipper-0.0.5/fipper/methods/messages/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/copy_media_group.py` & `fipper-0.0.5/fipper/methods/messages/copy_media_group.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/copy_message.py` & `fipper-0.0.5/fipper/methods/messages/copy_message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/delete_messages.py` & `fipper-0.0.5/fipper/methods/messages/delete_messages.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/download_media.py` & `fipper-0.0.5/fipper/methods/messages/download_media.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/edit_inline_caption.py` & `fipper-0.0.5/fipper/methods/messages/edit_inline_caption.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/edit_inline_media.py` & `fipper-0.0.5/fipper/methods/messages/edit_inline_media.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/edit_inline_reply_markup.py` & `fipper-0.0.5/fipper/methods/messages/edit_inline_reply_markup.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/edit_inline_text.py` & `fipper-0.0.5/fipper/methods/messages/edit_inline_text.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/edit_message_caption.py` & `fipper-0.0.5/fipper/methods/messages/edit_message_caption.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/edit_message_media.py` & `fipper-0.0.5/fipper/methods/messages/edit_message_media.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/edit_message_reply_markup.py` & `fipper-0.0.5/fipper/methods/messages/edit_message_reply_markup.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/edit_message_text.py` & `fipper-0.0.5/fipper/methods/messages/edit_message_text.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/forward_messages.py` & `fipper-0.0.5/fipper/methods/messages/forward_messages.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/get_chat_history.py` & `fipper-0.0.5/fipper/methods/messages/get_chat_history.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/get_chat_history_count.py` & `fipper-0.0.5/fipper/methods/messages/get_chat_history_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/get_custom_emoji_stickers.py` & `fipper-0.0.5/fipper/methods/messages/get_custom_emoji_stickers.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/get_discussion_message.py` & `fipper-0.0.5/fipper/methods/messages/get_discussion_message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/get_discussion_replies.py` & `fipper-0.0.5/fipper/methods/messages/get_discussion_replies.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/get_discussion_replies_count.py` & `fipper-0.0.5/fipper/methods/messages/get_discussion_replies_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/get_media_group.py` & `fipper-0.0.5/fipper/methods/messages/get_media_group.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/get_messages.py` & `fipper-0.0.5/fipper/methods/messages/get_messages.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/inline_session.py` & `fipper-0.0.5/fipper/methods/messages/inline_session.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/read_chat_history.py` & `fipper-0.0.5/fipper/methods/messages/read_chat_history.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/retract_vote.py` & `fipper-0.0.5/fipper/methods/messages/retract_vote.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/search_global.py` & `fipper-0.0.5/fipper/methods/messages/search_global.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/search_global_count.py` & `fipper-0.0.5/fipper/methods/messages/search_global_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/search_messages.py` & `fipper-0.0.5/fipper/methods/messages/search_messages.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/search_messages_count.py` & `fipper-0.0.5/fipper/methods/messages/search_messages_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_animation.py` & `fipper-0.0.5/fipper/methods/messages/send_animation.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_audio.py` & `fipper-0.0.5/fipper/methods/messages/send_audio.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_cached_media.py` & `fipper-0.0.5/fipper/methods/messages/send_cached_media.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_chat_action.py` & `fipper-0.0.5/fipper/methods/messages/send_chat_action.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_contact.py` & `fipper-0.0.5/fipper/methods/messages/send_contact.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_dice.py` & `fipper-0.0.5/fipper/methods/messages/send_dice.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_document.py` & `fipper-0.0.5/fipper/methods/messages/send_document.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_location.py` & `fipper-0.0.5/fipper/methods/messages/send_location.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_media_group.py` & `fipper-0.0.5/fipper/methods/messages/send_media_group.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_message.py` & `fipper-0.0.5/fipper/methods/messages/send_message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_photo.py` & `fipper-0.0.5/fipper/methods/messages/send_photo.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_poll.py` & `fipper-0.0.5/fipper/methods/messages/send_poll.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_reaction.py` & `fipper-0.0.5/fipper/methods/messages/send_reaction.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_sticker.py` & `fipper-0.0.5/fipper/methods/messages/send_sticker.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_venue.py` & `fipper-0.0.5/fipper/methods/messages/send_venue.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_video.py` & `fipper-0.0.5/fipper/methods/messages/send_video.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_video_note.py` & `fipper-0.0.5/fipper/methods/messages/send_video_note.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/send_voice.py` & `fipper-0.0.5/fipper/methods/messages/send_voice.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/stop_poll.py` & `fipper-0.0.5/fipper/methods/messages/stop_poll.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/stream_media.py` & `fipper-0.0.5/fipper/methods/messages/stream_media.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/vote_poll.py` & `fipper-0.0.5/fipper/methods/messages/vote_poll.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/wait_for_callback_query.py` & `fipper-0.0.5/fipper/methods/messages/wait_for_callback_query.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/messages/wait_for_message.py` & `fipper-0.0.5/fipper/methods/messages/wait_for_message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/mongo/__init__.py` & `fipper-0.0.5/fipper/methods/mongo/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/mongo/core.py` & `fipper-0.0.5/fipper/methods/mongo/core.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/password/__init__.py` & `fipper-0.0.5/fipper/methods/password/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/password/change_cloud_password.py` & `fipper-0.0.5/fipper/methods/password/change_cloud_password.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/password/enable_cloud_password.py` & `fipper-0.0.5/fipper/methods/password/enable_cloud_password.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/password/remove_cloud_password.py` & `fipper-0.0.5/fipper/methods/password/remove_cloud_password.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/__init__.py` & `fipper-0.0.5/fipper/methods/users/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/block_user.py` & `fipper-0.0.5/fipper/methods/users/block_user.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/delete_profile_photos.py` & `fipper-0.0.5/fipper/methods/users/delete_profile_photos.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/get_chat_photos.py` & `fipper-0.0.5/fipper/methods/users/get_chat_photos.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/get_chat_photos_count.py` & `fipper-0.0.5/fipper/methods/users/get_chat_photos_count.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/get_common_chats.py` & `fipper-0.0.5/fipper/methods/users/get_common_chats.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/get_default_emoji_statuses.py` & `fipper-0.0.5/fipper/methods/users/get_default_emoji_statuses.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/get_me.py` & `fipper-0.0.5/fipper/methods/users/get_me.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/get_users.py` & `fipper-0.0.5/fipper/methods/users/get_users.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/set_emoji_status.py` & `fipper-0.0.5/fipper/methods/users/set_emoji_status.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/set_profile_photo.py` & `fipper-0.0.5/fipper/methods/users/set_profile_photo.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/set_username.py` & `fipper-0.0.5/fipper/methods/users/set_username.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/unblock_user.py` & `fipper-0.0.5/fipper/methods/users/unblock_user.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/users/update_profile.py` & `fipper-0.0.5/fipper/methods/users/update_profile.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/__init__.py` & `fipper-0.0.5/fipper/methods/utilities/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/add_handler.py` & `fipper-0.0.5/fipper/methods/utilities/add_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/compose.py` & `fipper-0.0.5/fipper/methods/utilities/compose.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/export_session_string.py` & `fipper-0.0.5/fipper/methods/utilities/export_session_string.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/idle.py` & `fipper-0.0.5/fipper/methods/utilities/idle.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/remove_handler.py` & `fipper-0.0.5/fipper/methods/utilities/remove_handler.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/restart.py` & `fipper-0.0.5/fipper/methods/utilities/restart.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/run.py` & `fipper-0.0.5/fipper/methods/utilities/run.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/start.py` & `fipper-0.0.5/fipper/methods/utilities/start.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/stop.py` & `fipper-0.0.5/fipper/methods/utilities/stop.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/methods/utilities/stop_transmission.py` & `fipper-0.0.5/fipper/methods/utilities/stop_transmission.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/mime_types.py` & `fipper-0.0.5/fipper/mime_types.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/parser/__init__.py` & `fipper-0.0.5/fipper/parser/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/parser/html.py` & `fipper-0.0.5/fipper/parser/html.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/parser/markdown.py` & `fipper-0.0.5/fipper/parser/markdown.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/parser/parser.py` & `fipper-0.0.5/fipper/parser/parser.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/parser/utils.py` & `fipper-0.0.5/fipper/parser/utils.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/__init__.py` & `fipper-0.0.5/fipper/raw/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/__init__.py` & `fipper-0.0.5/fipper/raw/core/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/future_salt.py` & `fipper-0.0.5/fipper/raw/core/future_salt.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/future_salts.py` & `fipper-0.0.5/fipper/raw/core/future_salts.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/gzip_packed.py` & `fipper-0.0.5/fipper/raw/core/gzip_packed.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/list.py` & `fipper-0.0.5/fipper/raw/core/list.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/message.py` & `fipper-0.0.5/fipper/raw/core/message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/msg_container.py` & `fipper-0.0.5/fipper/raw/core/msg_container.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/primitives/__init__.py` & `fipper-0.0.5/fipper/raw/core/primitives/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/primitives/bool.py` & `fipper-0.0.5/fipper/raw/core/primitives/bool.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/primitives/bytes.py` & `fipper-0.0.5/fipper/raw/core/primitives/bytes.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/primitives/double.py` & `fipper-0.0.5/fipper/raw/core/primitives/double.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/primitives/int.py` & `fipper-0.0.5/fipper/raw/core/primitives/int.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/primitives/string.py` & `fipper-0.0.5/fipper/raw/core/primitives/string.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/primitives/vector.py` & `fipper-0.0.5/fipper/raw/core/primitives/vector.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/raw/core/tl_object.py` & `fipper-0.0.5/fipper/raw/core/tl_object.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/session/__init__.py` & `fipper-0.0.5/fipper/session/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/session/auth.py` & `fipper-0.0.5/fipper/session/auth.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/session/internals/__init__.py` & `fipper-0.0.5/fipper/session/internals/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/session/internals/data_center.py` & `fipper-0.0.5/fipper/session/internals/data_center.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/session/internals/msg_factory.py` & `fipper-0.0.5/fipper/session/internals/msg_factory.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/session/internals/msg_id.py` & `fipper-0.0.5/fipper/session/internals/msg_id.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/session/internals/seq_no.py` & `fipper-0.0.5/fipper/session/internals/seq_no.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/session/session.py` & `fipper-0.0.5/fipper/session/session.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/storage/__init__.py` & `fipper-0.0.5/fipper/storage/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/storage/file_storage.py` & `fipper-0.0.5/fipper/storage/file_storage.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/storage/memory_storage.py` & `fipper-0.0.5/fipper/storage/memory_storage.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/storage/sqlite_storage.py` & `fipper-0.0.5/fipper/storage/sqlite_storage.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/storage/storage.py` & `fipper-0.0.5/fipper/storage/storage.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/sync.py` & `fipper-0.0.5/fipper/sync.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/__init__.py` & `fipper-0.0.5/fipper/types/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/authorization/__init__.py` & `fipper-0.0.5/fipper/types/authorization/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/authorization/sent_code.py` & `fipper-0.0.5/fipper/types/authorization/sent_code.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/authorization/terms_of_service.py` & `fipper-0.0.5/fipper/types/authorization/terms_of_service.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/__init__.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/bot_command.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/bot_command.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/bot_command_scope.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/bot_command_scope.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/bot_command_scope_all_chat_administrators.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/bot_command_scope_all_chat_administrators.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/bot_command_scope_all_group_chats.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/bot_command_scope_all_group_chats.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/bot_command_scope_all_private_chats.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/bot_command_scope_all_private_chats.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/bot_command_scope_chat.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/bot_command_scope_chat.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/bot_command_scope_chat_administrators.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/bot_command_scope_chat_administrators.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/bot_command_scope_chat_member.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/bot_command_scope_chat_member.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/bot_command_scope_default.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/bot_command_scope_default.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/callback_game.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/callback_game.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/callback_query.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/callback_query.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/force_reply.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/force_reply.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/game_high_score.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/game_high_score.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/inline_keyboard_button.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/inline_keyboard_button.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/inline_keyboard_markup.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/inline_keyboard_markup.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/keyboard_button.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/keyboard_button.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/login_url.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/login_url.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/menu_button.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/menu_button.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/menu_button_commands.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/menu_button_commands.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/menu_button_default.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/menu_button_default.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/menu_button_web_app.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/menu_button_web_app.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/reply_keyboard_markup.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/reply_keyboard_markup.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/reply_keyboard_remove.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/reply_keyboard_remove.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/sent_web_app_message.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/sent_web_app_message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/bots_and_keyboards/web_app_info.py` & `fipper-0.0.5/fipper/types/bots_and_keyboards/web_app_info.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/__init__.py` & `fipper-0.0.5/fipper/types/inline_mode/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/chosen_inline_result.py` & `fipper-0.0.5/fipper/types/inline_mode/chosen_inline_result.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_animation.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_animation.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_article.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_article.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_audio.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_audio.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_cached_animation.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_cached_animation.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_cached_audio.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_cached_audio.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_cached_document.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_cached_document.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_cached_photo.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_cached_photo.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_cached_sticker.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_cached_sticker.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_cached_video.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_cached_video.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_cached_voice.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_cached_voice.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_contact.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_contact.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_document.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_document.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_location.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_location.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_photo.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_photo.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_venue.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_venue.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_video.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_video.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/inline_mode/inline_query_result_voice.py` & `fipper-0.0.5/fipper/types/inline_mode/inline_query_result_voice.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_media/__init__.py` & `fipper-0.0.5/fipper/types/input_media/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_media/input_media.py` & `fipper-0.0.5/fipper/types/input_media/input_media.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_media/input_media_animation.py` & `fipper-0.0.5/fipper/types/input_media/input_media_animation.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_media/input_media_audio.py` & `fipper-0.0.5/fipper/types/input_media/input_media_audio.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_media/input_media_document.py` & `fipper-0.0.5/fipper/types/input_media/input_media_document.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_media/input_media_photo.py` & `fipper-0.0.5/fipper/types/input_media/input_media_photo.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_media/input_media_video.py` & `fipper-0.0.5/fipper/types/input_media/input_media_video.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_media/input_phone_contact.py` & `fipper-0.0.5/fipper/types/input_media/input_phone_contact.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_message_content/__init__.py` & `fipper-0.0.5/fipper/types/input_message_content/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_message_content/input_message_content.py` & `fipper-0.0.5/fipper/types/input_message_content/input_message_content.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/input_message_content/input_text_message_content.py` & `fipper-0.0.5/fipper/types/input_message_content/input_text_message_content.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/list.py` & `fipper-0.0.5/fipper/types/list.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/__init__.py` & `fipper-0.0.5/fipper/types/messages_and_media/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/animation.py` & `fipper-0.0.5/fipper/types/messages_and_media/animation.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/audio.py` & `fipper-0.0.5/fipper/types/messages_and_media/audio.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/contact.py` & `fipper-0.0.5/fipper/types/messages_and_media/contact.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/dice.py` & `fipper-0.0.5/fipper/types/messages_and_media/dice.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/document.py` & `fipper-0.0.5/fipper/types/messages_and_media/document.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/game.py` & `fipper-0.0.5/fipper/types/messages_and_media/game.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/location.py` & `fipper-0.0.5/fipper/types/messages_and_media/location.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/message.py` & `fipper-0.0.5/fipper/types/messages_and_media/message.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/message_entity.py` & `fipper-0.0.5/fipper/types/messages_and_media/message_entity.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/message_reactions.py` & `fipper-0.0.5/fipper/types/messages_and_media/message_reactions.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/photo.py` & `fipper-0.0.5/fipper/types/messages_and_media/photo.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/poll.py` & `fipper-0.0.5/fipper/types/messages_and_media/poll.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/poll_option.py` & `fipper-0.0.5/fipper/types/messages_and_media/poll_option.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/reaction.py` & `fipper-0.0.5/fipper/types/messages_and_media/reaction.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/sticker.py` & `fipper-0.0.5/fipper/types/messages_and_media/sticker.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/stripped_thumbnail.py` & `fipper-0.0.5/fipper/types/messages_and_media/stripped_thumbnail.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/thumbnail.py` & `fipper-0.0.5/fipper/types/messages_and_media/thumbnail.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/venue.py` & `fipper-0.0.5/fipper/types/messages_and_media/venue.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/video.py` & `fipper-0.0.5/fipper/types/messages_and_media/video.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/video_note.py` & `fipper-0.0.5/fipper/types/messages_and_media/video_note.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/voice.py` & `fipper-0.0.5/fipper/types/messages_and_media/voice.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/web_app_data.py` & `fipper-0.0.5/fipper/types/messages_and_media/web_app_data.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/messages_and_media/web_page.py` & `fipper-0.0.5/fipper/types/messages_and_media/web_page.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/object.py` & `fipper-0.0.5/fipper/types/object.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/update.py` & `fipper-0.0.5/fipper/types/update.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/__init__.py` & `fipper-0.0.5/fipper/types/user_and_chats/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_admin_with_invite_links.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_admin_with_invite_links.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_event.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_event.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_event_filter.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_event_filter.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_invite_link.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_invite_link.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_join_request.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_join_request.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_joiner.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_joiner.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_member.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_member.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_member_updated.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_member_updated.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_permissions.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_permissions.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_photo.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_photo.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_preview.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_preview.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_privileges.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_privileges.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/chat_reactions.py` & `fipper-0.0.5/fipper/types/user_and_chats/chat_reactions.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/dialog.py` & `fipper-0.0.5/fipper/types/user_and_chats/dialog.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/emoji_status.py` & `fipper-0.0.5/fipper/types/user_and_chats/emoji_status.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/invite_link_importer.py` & `fipper-0.0.5/fipper/types/user_and_chats/invite_link_importer.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/restriction.py` & `fipper-0.0.5/fipper/types/user_and_chats/restriction.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/user.py` & `fipper-0.0.5/fipper/types/user_and_chats/user.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/video_chat_ended.py` & `fipper-0.0.5/fipper/types/user_and_chats/video_chat_ended.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/video_chat_members_invited.py` & `fipper-0.0.5/fipper/types/user_and_chats/video_chat_members_invited.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/video_chat_scheduled.py` & `fipper-0.0.5/fipper/types/user_and_chats/video_chat_scheduled.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/types/user_and_chats/video_chat_started.py` & `fipper-0.0.5/fipper/types/user_and_chats/video_chat_started.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper/utils.py` & `fipper-0.0.5/fipper/utils.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/fipper.egg-info/PKG-INFO` & `fipper-0.0.5/fipper.egg-info/PKG-INFO`
...
### Comparing `fipper-0.0.4.dev4/fipper.egg-info/SOURCES.txt` & `fipper-0.0.5/fipper.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/setup.py` & `fipper-0.0.5/setup.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/tests/__init__.py` & `fipper-0.0.5/tests/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/tests/filters/__init__.py` & `fipper-0.0.5/tests/filters/__init__.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/tests/filters/test_command.py` & `fipper-0.0.5/tests/filters/test_command.py`

 * *Files identical despite different names*

### Comparing `fipper-0.0.4.dev4/tests/test_file_id.py` & `fipper-0.0.5/tests/test_file_id.py`
