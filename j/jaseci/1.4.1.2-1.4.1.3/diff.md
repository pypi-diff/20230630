# Comparing `tmp/jaseci-1.4.1.2.tar.gz` & `tmp/jaseci-1.4.1.3.tar.gz`
...
### Comparing `jaseci-1.4.1.2/jaseci/__init__.py` & `jaseci-1.4.1.3/jaseci/__init__.py`
...
### Comparing `jaseci-1.4.1.2/jaseci/extens/act_lib/tests/test_regex.py` & `jaseci-1.4.1.3/jaseci/extens/act_lib/tests/test_regex.py`
...
### Comparing `jaseci-1.4.1.2/jaseci/jac/interpreter/sentinel_interp.py` & `jaseci-1.4.1.3/jaseci/jac/interpreter/sentinel_interp.py`
...
### Comparing `jaseci-1.4.1.2/jaseci/jac/ir/passes/pt_prune_pass.py` & `jaseci-1.4.1.3/jaseci/jac/ir/passes/pt_prune_pass.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/ir/passes/schedule.py` & `jaseci-1.4.1.3/jaseci/jac/ir/passes/schedule.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jac.g4` & `jaseci-1.4.1.3/jaseci/jac/jac.g4`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jac_parse/jacLexer.py` & `jaseci-1.4.1.3/jaseci/jac/jac_parse/jacLexer.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jac_parse/jacListener.py` & `jaseci-1.4.1.3/jaseci/jac/jac_parse/jacListener.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jac_parse/jacParser.py` & `jaseci-1.4.1.3/jaseci/jac/jac_parse/jacParser.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jac_set.py` & `jaseci-1.4.1.3/jaseci/jac/jac_set.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jsci_vm/disasm.py` & `jaseci-1.4.1.3/jaseci/jac/jsci_vm/disasm.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jsci_vm/inst_ptr.py` & `jaseci-1.4.1.3/jaseci/jac/jsci_vm/inst_ptr.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jsci_vm/machine.py` & `jaseci-1.4.1.3/jaseci/jac/jsci_vm/machine.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jsci_vm/op_codes.py` & `jaseci-1.4.1.3/jaseci/jac/jsci_vm/op_codes.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/jsci_vm/tests/test_codegen.py` & `jaseci-1.4.1.3/jaseci/jac/jsci_vm/tests/test_codegen.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/machine/jac_scope.py` & `jaseci-1.4.1.3/jaseci/jac/machine/jac_scope.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/machine/jac_value.py` & `jaseci-1.4.1.3/jaseci/jac/machine/jac_value.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/machine/machine_state.py` & `jaseci-1.4.1.3/jaseci/jac/machine/machine_state.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/tests/book_code.py` & `jaseci-1.4.1.3/jaseci/jac/tests/book_code.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/tests/test_book.py` & `jaseci-1.4.1.3/jaseci/jac/tests/test_book.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jac/tests/test_lang_14.py` & `jaseci-1.4.1.3/jaseci/jac/tests/test_lang_14.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/jsorc.py` & `jaseci-1.4.1.3/jaseci/jsorc/jsorc.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/jsorc_settings.py` & `jaseci-1.4.1.3/jaseci/jsorc/jsorc_settings.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/jsorc_utils.py` & `jaseci-1.4.1.3/jaseci/jsorc/jsorc_utils.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/live_actions.py` & `jaseci-1.4.1.3/jaseci/jsorc/live_actions.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/manifests/database.yaml` & `jaseci-1.4.1.3/jaseci/jsorc/manifests/database.yaml`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/manifests/elastic.yaml` & `jaseci-1.4.1.3/jaseci/jsorc/manifests/elastic.yaml`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/manifests/prometheus.yaml` & `jaseci-1.4.1.3/jaseci/jsorc/manifests/prometheus.yaml`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/manifests/redis.yaml` & `jaseci-1.4.1.3/jaseci/jsorc/manifests/redis.yaml`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/memory.py` & `jaseci-1.4.1.3/jaseci/jsorc/memory.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/redis.py` & `jaseci-1.4.1.3/jaseci/jsorc/redis.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/remote_actions.py` & `jaseci-1.4.1.3/jaseci/jsorc/remote_actions.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/tests/test_actions.py` & `jaseci-1.4.1.3/jaseci/jsorc/tests/test_actions.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/jsorc/tests/test_jsorc.py` & `jaseci-1.4.1.3/jaseci/jsorc/tests/test_jsorc.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/ability.py` & `jaseci-1.4.1.3/jaseci/prim/ability.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/architype.py` & `jaseci-1.4.1.3/jaseci/prim/architype.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/edge.py` & `jaseci-1.4.1.3/jaseci/prim/edge.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/element.py` & `jaseci-1.4.1.3/jaseci/prim/element.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/graph.py` & `jaseci-1.4.1.3/jaseci/prim/graph.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/master.py` & `jaseci-1.4.1.3/jaseci/prim/master.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/node.py` & `jaseci-1.4.1.3/jaseci/prim/node.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/obj_mixins.py` & `jaseci-1.4.1.3/jaseci/prim/obj_mixins.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/sentinel.py` & `jaseci-1.4.1.3/jaseci/prim/sentinel.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/super_master.py` & `jaseci-1.4.1.3/jaseci/prim/super_master.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/prim/walker.py` & `jaseci-1.4.1.3/jaseci/prim/walker.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/tests/infer.py` & `jaseci-1.4.1.3/jaseci/tests/infer.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/tests/jac_test_code.py` & `jaseci-1.4.1.3/jaseci/tests/jac_test_code.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/tests/jac_test_progs.py` & `jaseci-1.4.1.3/jaseci/tests/jac_test_progs.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/tests/test_core.py` & `jaseci-1.4.1.3/jaseci/tests/test_core.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/tests/test_jac.py` & `jaseci-1.4.1.3/jaseci/tests/test_jac.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/tests/test_node.py` & `jaseci-1.4.1.3/jaseci/tests/test_node.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/tests/test_progs.py` & `jaseci-1.4.1.3/jaseci/tests/test_progs.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/tests/test_stack.py` & `jaseci-1.4.1.3/jaseci/tests/test_stack.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/tests/test_stripe.py` & `jaseci-1.4.1.3/jaseci/tests/test_stripe.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/utils/actions/actions_manager.py` & `jaseci-1.4.1.3/jaseci/utils/actions/actions_manager.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/utils/actions/actions_optimizer.py` & `jaseci-1.4.1.3/jaseci/utils/actions/actions_optimizer.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/utils/actions/actions_state.py` & `jaseci-1.4.1.3/jaseci/utils/actions/actions_state.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/utils/gprof2dot.py` & `jaseci-1.4.1.3/jaseci/utils/gprof2dot.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/utils/id_list.py` & `jaseci-1.4.1.3/jaseci/utils/id_list.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/utils/json_handler.py` & `jaseci-1.4.1.3/jaseci/utils/json_handler.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/utils/log_utils.py` & `jaseci-1.4.1.3/jaseci/utils/log_utils.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/utils/test_core.py` & `jaseci-1.4.1.3/jaseci/utils/test_core.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci/utils/utils.py` & `jaseci-1.4.1.3/jaseci/utils/utils.py`

 * *Files identical despite different names*

### Comparing `jaseci-1.4.1.2/jaseci.egg-info/SOURCES.txt` & `jaseci-1.4.1.3/jaseci.egg-info/SOURCES.txt`
...
+jaseci/extens/api/tests/test_uncommon.py
...
### Comparing `jaseci-1.4.1.2/setup.py` & `jaseci-1.4.1.3/setup.py`
