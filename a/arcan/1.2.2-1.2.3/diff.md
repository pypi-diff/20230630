# Comparing `tmp/arcan-1.2.2.tar.gz` & `tmp/arcan-1.2.3.tar.gz`
...
## Comparing `arcan-1.2.2.tar` & `arcan-1.2.3.tar`
...
### Comparing `arcan-1.2.2/LICENSE` & `arcan-1.2.3/LICENSE`

 * *Files identical despite different names*

### Comparing `arcan-1.2.2/README.md` & `arcan-1.2.3/README.md`

 * *Files identical despite different names*

### Comparing `arcan-1.2.2/arcan/__init__.py` & `arcan-1.2.3/arcan/__init__.py`
...
### Comparing `arcan-1.2.2/pyproject.toml` & `arcan-1.2.3/pyproject.toml`
...
### Comparing `arcan-1.2.2/PKG-INFO` & `arcan-1.2.3/PKG-INFO`
