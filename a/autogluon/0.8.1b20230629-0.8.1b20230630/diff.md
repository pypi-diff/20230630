# Comparing `tmp/autogluon-0.8.1b20230629.tar.gz` & `tmp/autogluon-0.8.1b20230630.tar.gz`
...
## Comparing `autogluon-0.8.1b20230629.tar` & `autogluon-0.8.1b20230630.tar`
...
### Comparing `autogluon-0.8.1b20230629/PKG-INFO` & `autogluon-0.8.1b20230630/PKG-INFO`
...
### Comparing `autogluon-0.8.1b20230629/setup.py` & `autogluon-0.8.1b20230630/setup.py`

 * *Files identical despite different names*

### Comparing `autogluon-0.8.1b20230629/src/autogluon.egg-info/PKG-INFO` & `autogluon-0.8.1b20230630/src/autogluon.egg-info/PKG-INFO`
